	...
	<table class="ntable"> 
		...
		<c:if test="${not empty banana}">
			...
			<tr class="ntable_tr">
				...
				<td><a href="shareDetail?shno=${banana.shno}">${banana.title}</a></td>
				<td>${banana.nname}</td>
	...
	<div align="center">
		...
		<c:choose>
			<c:when test="${pageMaker.prev && pageMaker.spageNo>1}">
				<a href="shareList${pageMaker.searchQuery(1)}">&lt;&lt;</a>&nbsp;     
				<a href="shareList${pageMaker.searchQuery(pageMaker.spageNo-1)}">&lt;</a>&nbsp;&nbsp;  
			</c:when>
			<c:otherwise>
		...
		<c:forEach var="i" begin="${pageMaker.spageNo}" end="${pageMaker.epageNo}">
			...
			<c:if test="${i != pageMaker.cri.currPage}">
				<a href="shareList${pageMaker.searchQuery(i)}">${i}</a>&nbsp;
