	...
	<div class="ArticleContentBox">
				...
				<div class="write_info_box">
					<c:if test="${loginID == apple.id}">
						<div class="update_delete">
							<a href="shareDetail?jCode=U&shno=${apple.shno}"
								class="write_btn">글수정</a> <a
								href="shareDelete?shno=${apple.shno}" class="delete_btn">글삭제</a>
						</div>
					</c:if>
		...
		<div class="article_container">
			...
			<div class="article_writer">
				<a
					href="shareWriterList?id=${apple.id}&uploadfile=${apple.uploadfile}">
		...
		<div class="CommentBox">
								...
								<div class="n_comment_area pd_15 ">
									...
									<div class="comment_box">
										...
										orange 의 vo 로 담겨져 있음 -->
											<form action="s_rereplyInsert" id="rereplyInsert"
												class="rereplyInsert">
												<!-- nno는 현재 noticeController -> ndetail 메서드 ->
													apple 의 vo 로 담겨있으므로, apple.nno 로 호출해야함 -->
												<input type="hidden" name="shno" value="${apple.shno}"
										...
										<div class="comment_inbox re_box_update dp_h">
											<!-- grp 는 현재 noticeController -> ndetail 메서드 ->
										orange 의 vo 로 담겨져 있음 -->
											<form action="s_replyUpdate" id="replyUpdate"
												class="replyUpdate">
												...
												<div class="comment_attach">
													...
													<input type="reset" value="취소"> <input
														type="hidden" name="shno" value="${orange.shno}">
							...
							<c:if test="${orange.grpl != 0}">
								...
								<div class="n_comment_area  pd_55 ">
									...
									<div class="comment_box">
										...
										<div class="comment_info_box">
											<span class="comment_info_reg">${orange.regdate}</span> <a
										...
										<div class="comment_inbox rere_box dp_h">
											<!-- grp 는 현재 noticeController -> ndetail 메서드 ->
										orange 의 vo 로 담겨져 있음 -->
											<form action="s_rereplyInsert" id="rerereplyInsert"
												class="rerereplyInsert">
												<!-- nno는 현재 noticeController -> ndetail 메서드 ->
													apple 의 vo 로 담겨있으므로, apple.nno 로 호출해야함 -->
												<input type="hidden" name="shno" value="${apple.shno}"
													id="shno"> <input type="hidden" name="id"
												...
												<div class="comment_attach">
													...
													<input type="reset" value="취소"> <input
														type="hidden" name="grp" value="${orange.grp}"> <input
														type="hidden" name="grps" value="${orange.grps}">
													<input type="hidden" name="grpl" value="${orange.grpl}">
												</div>
											</form>
										...
										<div class="comment_inbox re_box_update dp_h">
											<!-- grp 는 현재 noticeController -> ndetail 메서드 ->
										orange 의 vo 로 담겨져 있음 -->
											<form action="s_replyUpdate" id="rereplyUpdate"
												class="rereplyUpdate">
			...
			<c:if test="${not empty loginID}">
				<form action="s_replyInsert" method="post" id="replyInsert"
					class="replyInsert">
			...
			<c:if test="${empty loginID}">
				<div class="CommentWriter">
					<div class="comment_inbox">
						<textarea name="content" id="content"
							placeholder="로그인 후 댓글을 남겨보세요." class="comment_textarea"></textarea>
						<div class="comment_attach">
							<input type="text" name="commentData" id="commentData" value="등록">
						</div>
					</div>
				</div>
			</c:if>
...
${message}<br>
	...
	<div class="list_forward">
		<a href="shareList" class="list_a">목록으로</a> <a
