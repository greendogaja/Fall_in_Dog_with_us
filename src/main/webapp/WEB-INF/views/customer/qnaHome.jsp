				...
				<div align="center" class="pagecs">
					...
					<c:choose>
						<c:when test="${pageMaker.prev && pageMaker.spageNo>1}">
							<a href="qna${pageMaker.searchQuery(1)}" >처음</a>&nbsp;
						</c:when>
						<c:when test="${pageMaker.cri.currPage != 1 }">
							<a href="qna${pageMaker.searchQuery(pageMaker.cri.currPage-1)}" >&lt;</a>&nbsp;&nbsp; 
						</c:when>
					</c:choose>
					<!-- Displag PageNo -->
					...
					<c:choose>
						<c:when test="${pageMaker.next && pageMaker.epageNo>0}">
							<a href="qna${pageMaker.searchQuery(pageMaker.lastPageNo)}" >&nbsp;마지막</a>
						</c:when>
