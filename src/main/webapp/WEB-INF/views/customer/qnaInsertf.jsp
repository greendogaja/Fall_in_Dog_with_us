...
<body>
    ...
    <div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
            ...
            </div><!-- single-hero-slide bg-img -->
        </div><!-- hero-slides owl-carousel -->
    </div><!-- hero-area -->
    <!-- ##### Hero Area End ##### -->
			...
			<div class="bbox-in">
				<div class="write" style="width: 100%; margin: auto;">
					<form method="post" action="qnainsert"  enctype="multipart/form-data">
						...
						<input  type="hidden" name="nickname" value="${loginNick}"/>
						...
						<table class="tableqna">
							...
							<tr>
								<th>제목</th>
								<td>
									<input type="text" name="title"  class="qnatitle" title="제목" >
								</td>
							</tr>
							<!-- 내용 -->
							<tr>
