...
<body>
    ...
    <div id="content">
        <div class="dog_Detail">
            <img src="/resources/img/dogs/01.jpg" alt="image" class="dog_Detail_Img">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3" class="last">fid_(날짜)_(글번호)</td>
                    </tr>

                    <tr>
                        <th class="first">상태</th>
                        <td colspan="3" class="last">보호중
                        </td>
                    </tr>

                    <tr>
                        <th class="first">품종</th>
                        <td colspan="3" class="last"> 믹스견</td>
                    </tr>

                    <tr>
                        <th scope="row" class="first">나이</th>
                        <td class="last">2020(년생)</td>
                        <th scope="row" class="first">체중</th>
                        <td class="last">90kg</td>
                    </tr>

                    <tr>
                        <th class="first">성별</th>
                        <td colspan="3" class="last">암컷</td>
                    </tr>

                    <tr>
                        <th class="first">중성화</th>
                        <td colspan="3" class="last">유</td>
                    </tr>


                    <tr>
                        <th class="first">특징</th>
                        <td colspan="3" class="last">약간 겁있음</td>
                    </tr>

                    <tr>
                        <th class="first">발견일자</th>
                        <td class="last">2022-11-03</td>
