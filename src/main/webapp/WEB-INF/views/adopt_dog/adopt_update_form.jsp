...
<div class="container" role="main">
			...
			<form action="adopt_update" method="Post">
				<input type="text" name="id" id="id" class="form-control" value="${loginID}" size="20" readonly hidden>
				<input type="text" name="ano" id="ano" class="form-control" value="${Adopt_detail.ano}" size="20" readonly hidden>
				<div class="mb-3">
					<label for="title">제목</label>
					<input type="text" name="title" id="title" class="form-control" value="${Adopt_detail.title}">
				</div>
				
				<div class="mb-3">
					<label for="content">내용</label>
					<textarea rows="10" class="form-control mb-3" name="content" id="content" >${Adopt_detail.content}</textarea>
