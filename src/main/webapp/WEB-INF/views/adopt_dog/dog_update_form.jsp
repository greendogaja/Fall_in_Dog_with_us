...
<body>
    ...
    <div class="container" role="main">
        ...
        <form action="dog_update" method="Post" enctype="multipart/form-data">
        	<input type="text" name="dno" id="dno" value="${Adopt_detail.dno}" readonly hidden>
            <input type="text" name="id" id="id" value="${loginID}" readonly hidden>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="last">
                                    <input type="text" name="age" id="age" class="form-control" value="${Adopt_detail.age}">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="last">
                                    <select name="size" id="size" class="form-control">
                                        <option value="s" selected>소형견</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="last">
                                	<img src="${Adopt_detail.img}" alt="image" class="dog_Detail_Img"><br>
                                	<input type="hidden" name="img" id="img" value="${Adopt_detail.img}">
