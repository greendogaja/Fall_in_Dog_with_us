		...
		<div class="paging-wrap">
			...
			<c:choose>
				<c:when test="${AdoptPageMaker.prev && AdoptPageMaker.spageNo>1}">
					<a href="dog_list_S${AdoptPageMaker.searchQuery(1)}" title="처음 페이지" class="com first"><span>처음</span></a>
					<a href="dog_list_S${AdoptPageMaker.searchQuery(AdoptPageMaker.spageNo-1)}" title="이전 페이지" class="com prev"><span>이전</span></a>
				</c:when>
			...
			<c:forEach  var="i" begin="${AdoptPageMaker.spageNo}" end="${AdoptPageMaker.epageNo}">
				...
				<c:if test="${i!=AdoptPageMaker.cri.currPage}">
					<a href="dog_list_S${AdoptPageMaker.searchQuery(i)}" class="com">${i}</a>
				</c:if>
			</c:forEach>
			...
			<c:choose>
				<c:when test="${AdoptPageMaker.next && AdoptPageMaker.epageNo>0}">
					<a href="dog_list_S${AdoptPageMaker.searchQuery(AdoptPageMaker.epageNo+1)}" title="다음 페이지" class="com next"><span>다음</span></a>
					<a href="dog_list_S${AdoptPageMaker.searchQuery(AdoptPageMaker.lastPageNo)}" title="마지막 페이지" class="com last"><span>마지막</span></a>
				</c:when>
